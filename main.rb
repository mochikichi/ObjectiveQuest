...
magic1 = Ability.new(name: 'メラ', type: 1 , mp_cost: 8, effect_amount: 50)
magic2 = Ability.new(name: 'メラゾーマ', type: 1 , mp_cost: 18, effect_amount: 120)
hero2.learn([magic1])
enemy2.learn([magic1, magic2])
